...
class SimulationService:
    ...
    def predict_target_variable(self, input_data: InputData):
        ...
        df_input = data_model_loader.df_input
        scaler = data_model_loader.scaler
        feature_indices = data_model_loader.feature_indices
        ...
        # MAPE 계산 및 클라이언트 반환
        evaluation_result = self.evaluate_model(target_variable_name)
    ...
    def evaluate_model(self, target_variable_name, test_size=0.2, random_state=42):
        ...
        target_index = data_model_loader.feature_indices[target_variable_name]
